...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexList = __webpack_require__(250);
	...
	var Roots = function (_Component) {
	    ...
	    function Roots() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Roots).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _reactRouter.Link,
	                            { to: '/?tab=all', activeClassName: 'active' },
	                            '全部'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'pictrue' },
	                                    _react2.default.createElement('img', { src: 'http://gravatar.com/avatar/871c4ba6d25169779cee977e04b2f0c3?s=48' })
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'div',
	...
	var Main = function (_Component3) {
	    ...
	    function Main(props) {
	        ...
	        _this3.redayDOM = function (props) {};
	        return _this3;
	    }
	...
	exports.default = (0, _reactRedux.connect)(function (state) {
	    return { state: state.IndexList };
	}, (0, _Index2.default)('IndexList'))(Main); //连接redux
...
/***/ function(module, exports) {
	...
	exports.default = function (_ID) {
	    var action = {};
	    var GET_LATEST_LIST_DATA_START = 'GET_LATEST_LIST_DATA_START'; //开始获取最新列表数据
	    var GET_LATEST_LIST_DATA_SUCCESS = 'GET_LATEST_LIST_DATA_SUCCESS'; //获取最新列表数据成功
	    var GET_LATEST_LIST_DATA_ERROR = 'GET_LATEST_LIST_DATA_ERROR'; //获取最新列表数据失败
	    var SETSCROLL = 'SETSCROLL'; //记录组件卸载前的滚动条位置
	    var RESET_DEFAULT_STATE = 'RESET_DEFAULT_STATE'; //重置默认状态
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objMerged = __webpack_require__(254);
	...
	var IndexList = function IndexList() {
	    ...
	    switch (action.type) {
	        ...
	        default:
	            return (0, _objMerged2.default)(state, { _ID: 'IndexList' }); //返回默认状态
	    }
	};

	exports.default = { IndexList: IndexList };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flex = __webpack_require__(262);
	var dataFlex = __webpack_require__(264);
